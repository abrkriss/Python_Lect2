# Задание 5.
# 1) Создайте собственный класс-исключение, который должен
...
# команду “stop”. При этом скрипт завершается, сформированный
...
# в список, только если введено число. Класс-исключение должен не позволить
# пользователю ввести текст (не число) и отобразить соответствующее сообщение.
# При этом работа скрипта не должна завершаться.
# """

class Isnt_number(ValueError):
    pass
...
while True:
    try:
        ...
        if not value.isdigit():
            raise Isnt_number(value)
        my_lst.append(int(value))
    except Isnt_number as ex:
        print('Не число!', ex)
print(my_lst)